		...
		<div class="row">
			<div class="col-md-6">
				<h2>Lista de Produtos</h2>
					<table class="table">
						<thead><tr><td>Código</td><td>Nome</td><td>Descrição</td><td>Estoque</td></tr></thead>
						<%
			...
			<div class="col-md-6">
				...
				<form action="pesquisa.jsp" method="get">
					<input type="text" id="pesquisar" name="pesquisar" class="form-control" placeholder="Pesquisar"> 
					<button type="submit" class="btn btn-default btn-lg btn-block" name="action" value="codigo">Pesquisar por código</button>
				</form>
				...
				<form action="remover.jsp" method="get">
					<input type="text" id="codigo" name="codigo" class="form-control" placeholder="Código do produto a ser removido" required>
